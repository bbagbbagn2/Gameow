		...
		<div className="bg-discord-bg min-h-screen">
			<div className="tb:px-6 tb:pt-12 pc:max-w-300 pc:px-25 m-auto flex w-full flex-col px-4 pt-8 pb-20">
							...
							<h2 className="tb:text-4xl text-3xl font-black tracking-tighter text-white">
								{REVIEWS_MESSAGE.subtitle.split(' ').map((word, i) => (
									<span
										key={i}
										className={
											i === 0 ? 'text-primary-500 decoration-primary-500/30 underline underline-offset-8' : ''
										}>
										{word}{' '}
									</span>
								))}
				...
				<div className="flex flex-col gap-10">
					...
					{/* 리뷰 점수 요약 영역 */}
					<div className="bg-discord-surface tb:p-8 rounded-2xl border border-white/5 p-6 shadow-xl">
